      ...
      (function() {
        ...
        function A(a) {
          for (var d = void 0, f = a.firstChild; f; f = f.nextSibling)
            var b = f.nodeType, d = 1 === b ? (d ? a : f) : 3 === b ? (T.test(f.nodeValue) ? a : d) : d;
          return d === a ? void 0 : d;
        }
        ...
        function C(a, d) {
          function f(a) {
            for (
              var m = a.i, k = a.h, c = [m, 'pln'], r = 0, W = a.a.match(g) || [], u = {}, e = 0, q = W.length;
              e < q;
              ++e
            ) {
              var D = W[e],
                ...
                for (
                  ...
                  if ((k !== h || u.test(q)) && !e.test(q)) {
                    ...
                    if (!m) {
                      ...
                      y = k.linenums;
                      (y = 'true' === y || +y) ||
                        (y = (y = q.match(/\blinenums\b(?::(\d+))?/)) ? (y[1] && y[1].length ? +y[1] : !0) : !1);
                      y && B(d, y, v);
                      H({
                        j: m,
                        h: d,
