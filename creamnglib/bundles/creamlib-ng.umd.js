(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/http'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/router'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@creamlib/ng', ['exports', '@angular/animations', '@angular/http', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/router', '@angular/platform-browser'], factory) :
    (factory((global.creamlib = global.creamlib || {}, global.creamlib.ng = {}),global.ng.animations,global.ng.http,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.router,global.ng.platformBrowser));
}(this, (function (exports,animations,http,rxjs,operators,core,router,platformBrowser) { 'use strict';
    ...
    var ToastComponent = /** @class */ (function () {
        ...
        ToastComponent.propDecorators = {
            ...
            closeBtn: [{ type: core.Input }],
            closeBtnTitle: [{ type: core.Input }],
            imgCloseBtn: [{ type: core.Input }],
    ...
    var AccordionItemComponent = /** @class */ (function () {
            ...
            { type: core.Component, args: [{
                        ...
                        animations: [
                            animations.trigger('openClose', [
                                ...
                                animations.transition('open => closed', [animations.animate('0.2s ease-in')]),
                                animations.transition('closed => open', [animations.animate('0.2s ease-in')])
                            ])
                        ],
                        encapsulation: core.ViewEncapsulation.None,
        ...
        AccordionItemComponent.propDecorators = {
            nameButton: [{ type: core.Input }],
            urlImage: [{ type: core.Input }],
    ...
    var CalendarComponent = /** @class */ (function () {
        ...
        CalendarComponent.propDecorators = {
            monthString: [{ type: core.Input }],
            targetString: [{ type: core.Input }],
            type: [{ type: core.Input }],
            dp: [{ type: core.ViewChild, args: ['dp',] }],
            prev: [{ type: core.ViewChild, args: ['prev',] }],
            next: [{ type: core.ViewChild, args: ['next',] }],
            grid: [{ type: core.ViewChild, args: ['cal',] }],
            buttonShow: [{ type: core.ViewChild, args: ['showDP',] }],
            target: [{ type: core.ViewChild, args: ['date',] }],
    ...
    var ListComponent = /** @class */ (function () {
        ...
        ListComponent.prototype.ngOnInit =
            ...
            function () {
                ...
                rxjs.from(this.http.get('assets/json/dataList.json'))
                    .pipe(operators.map(function (response) { return response.json(); })) // Specify JSON type
    ...
    var ListDescriptionComponent = /** @class */ (function () {
        // Constructor
        function ListDescriptionComponent(http$$1) {
            this.http = http$$1;
        }
        // On Init
        // On Init
        ...
        /** @nocollapse */
        ListDescriptionComponent.ctorParameters = function () {
            return [
                { type: http.Http }
            ];
        };
    ...
    var ListOrderComponent = /** @class */ (function () {
        // Constructor
        function ListOrderComponent(http$$1) {
            this.http = http$$1;
        }
        // On Init
        // On Init
    ...
    var ListThumbnailsComponent = /** @class */ (function () {
        // Constructor
        function ListThumbnailsComponent(http$$1) {
            this.http = http$$1;
        }
        // On Init
        // On Init
        ...
        /** @nocollapse */
        ListThumbnailsComponent.ctorParameters = function () {
            return [
                { type: http.Http }
            ];
        };
    ...
    var SelectComponent = /** @class */ (function () {
        // Constructor
        function SelectComponent(http$$1) {
            this.http = http$$1;
            this.id = '';
        }
        // On Init
        ...
        SelectComponent.prototype.ngOnInit =
            ...
            function () {
                var _this = this;
                // Get Data of a JSON (or other...)
                rxjs.from(this.http.get('assets/json/dataSelect.json'))
                    .pipe(operators.map(function (response) { return response.json(); })) // Specify JSON type
                    .subscribe(function (data) {
                    // Set items to response Json
    ...
    var SelectDatalistComponent = /** @class */ (function () {
        // Constructor
        function SelectDatalistComponent(http$$1) {
            this.http = http$$1;
            this.id = '';
        }
        // On Init
        ...
        /** @nocollapse */
        SelectDatalistComponent.ctorParameters = function () {
            return [
                { type: http.Http }
            ];
        };
        SelectDatalistComponent.propDecorators = {
            myInput: [{ type: core.ViewChild, args: ['inputList',] }],
            myDataList: [{ type: core.ViewChild, args: ['dataList',] }],
            title: [{ type: core.Input }],
            name: [{ type: core.Input }],
            id: [{ type: core.Input }],
    ...
    var SelectDatalistsComponent = /** @class */ (function () {
        // Constructor
        function SelectDatalistsComponent(http$$1) {
            this.http = http$$1;
            this.id1 = '';
            this.id2 = '';
        }
        ...
        /** @nocollapse */
        SelectDatalistsComponent.ctorParameters = function () {
            return [
                { type: http.Http }
            ];
        };
        SelectDatalistsComponent.propDecorators = {
            myInput1: [{ type: core.ViewChild, args: ['inputList1',] }],
            myInput2: [{ type: core.ViewChild, args: ['inputList2',] }],
            myDataList: [{ type: core.ViewChild, args: ['dataList',] }],
            title1: [{ type: core.Input }],
            title2: [{ type: core.Input }],
            name1: [{ type: core.Input }],
            name2: [{ type: core.Input }],
            id1: [{ type: core.Input }],
            id2: [{ type: core.Input }],
            list: [{ type: core.Input }]
        };
    ...
    var SliderComponent = /** @class */ (function () {
        ...
        SliderComponent.propDecorators = {
            ...
            required: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            input: [{ type: core.ViewChild, args: ['slider',] }],
            output: [{ type: core.ViewChild, args: ['output',] }],
    ...
    var StepItemComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        StepItemComponent.ctorParameters = function () {
            return [
                { type: StepComponent },
        ...
        StepItemComponent.propDecorators = {
            itemRef: [{ type: core.ViewChild, args: ['items',] }],
            title: [{ type: core.Input }],
            isActive: [{ type: core.Input }],
            isPassed: [{ type: core.Input }],
            stepLink: [{ type: core.Input }],
            indexStep: [{ type: core.Input }],
            reference: [{ type: core.Input }],
            Past: [{ type: core.Input, args: ['isPast',] }],
            Future: [{ type: core.Input, args: ['isFuture',] }]
        };
    ...
    var TabsComponent = /** @class */ (function () {
        ...
        TabsComponent.propDecorators = {
            tabsElement: [{ type: core.ViewChildren, args: ['tabs',] }],
            tabComponents: [{ type: core.ContentChildren, args: [TabComponent,] }],
            onResize: [{ type: core.HostListener, args: ['window:resize', ['$event'],] }]
        };
    ...
    var PaginationComponent = /** @class */ (function () {
        // Constructor
        function PaginationComponent(http$$1, pagerService) {
            this.http = http$$1;
        ...
        PaginationComponent.prototype.ngOnInit =
            ...
            function () {
                var _this = this;
                // Get Data of a JSON (or other...)
                rxjs.from(this.http.get('assets/json/dataPagination.json'))
                    .pipe(operators.map(function (response) { return response.json(); })) // Specify JSON type
                    .subscribe(function (data) {
                    // Set items to response Json
                    _this.allItems = data;
        ...
        PaginationComponent.propDecorators = {
            imgFirst: [{ type: core.Input }],
            imgBack: [{ type: core.Input }],
            imgNext: [{ type: core.Input }],
            imgLast: [{ type: core.Input }],
            pagination: [{ type: core.ViewChild, args: ['pagination',] }]
        };
    ...
    var ModalComponent = /** @class */ (function () {
        ...
        ModalComponent.propDecorators = {
            isOpen: [{ type: core.HostListener, args: ['window:resize', ['$event'],] }, { type: core.Input }],
            styleClass: [{ type: core.Input }],
            topPosition: [{ type: core.Input }],
            leftPosition: [{ type: core.Input }],
            modalWidth: [{ type: core.Input }],
            modaTitle: [{ type: core.Input }],
            closeBtnTitle: [{ type: core.Input }],
            onShow: [{ type: core.Output }],
            onHide: [{ type: core.Output }],
            dialogElement: [{ type: core.ViewChild, args: ['dialogElement',] }],
            container: [{ type: core.ViewChild, args: ['container',] }],
            focusable: [{ type: core.ViewChild, args: ['focusable',] }],
            getScreenSize: [{ type: core.HostListener, args: ['window:resize', ['$event'],] }]
        };
    ...
    var PaginationDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        PaginationDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 }
            ];
        ...
        PaginationDirective.propDecorators = {
            pager: [{ type: core.Input, args: ['c3mPaginationCurrent',] }]
        };
    ...
    var StepsDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        StepsDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 }
            ];
        ...
        StepsDirective.propDecorators = {
            activeStep: [{ type: core.Input, args: ['c3mStepCurrent',] }]
        };
    ...
    exports.CheckboxButtonComponent = CheckboxButtonComponent;
    exports.CheckboxGroupComponent = CheckboxGroupComponent;
    exports.CheckboxGroupItemComponent = CheckboxGroupItemComponent;
    exports.CheckboxLinkComponent = CheckboxLinkComponent;
    exports.DropdownComponent = DropdownComponent;
    exports.DropdownItemComponent = DropdownItemComponent;
    exports.FieldsetComponent = FieldsetComponent;
    exports.InputComponent = InputComponent;
    exports.InputErrorMsgComponent = InputErrorMsgComponent;
    exports.InputFloatingComponent = InputFloatingComponent;
    exports.InputMailComponent = InputMailComponent;
    exports.InputMaterialComponent = InputMaterialComponent;
    exports.InputPasswordComponent = InputPasswordComponent;
    exports.InputSearchComponent = InputSearchComponent;
    exports.InputTelComponent = InputTelComponent;
    exports.InputUrlComponent = InputUrlComponent;
    exports.ListComponent = ListComponent;
    exports.ListDescriptionComponent = ListDescriptionComponent;
    exports.ListOrderComponent = ListOrderComponent;
    exports.ListThumbnailsComponent = ListThumbnailsComponent;
    exports.RadioComponent = RadioComponent;
    exports.RadioItemComponent = RadioItemComponent;
    exports.SelectComponent = SelectComponent;
    exports.SelectDatalistComponent = SelectDatalistComponent;
    exports.SelectDatalistsComponent = SelectDatalistsComponent;
    exports.SkipComponent = SkipComponent;
    exports.SliderComponent = SliderComponent;
    exports.ProgressComponent = ProgressComponent;
    exports.SpinnerProgressComponent = SpinnerProgressComponent;
    exports.StepComponent = StepComponent;
    exports.StepItemComponent = StepItemComponent;
    exports.ColumnTableComponent = ColumnTableComponent;
    exports.ToggleTableComponent = ToggleTableComponent;
    exports.PageSwipeTableComponent = PageSwipeTableComponent;
    exports.TabsComponent = TabsComponent;
    exports.TabComponent = TabComponent;
    exports.PaginationComponent = PaginationComponent;
    exports.ModalComponent = ModalComponent;
    exports.ModalAlertComponent = ModalAlertComponent;
    ...
    exports.ɵa = PagerService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=creamlib-ng.umd.js.map